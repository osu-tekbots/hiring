...
class EmailActionHandler extends ActionHandler {
    ...
    public function handleSendEmail() {
        ...
        $mailer = new Mailer($position->getCommitteeEmail(), $this->configManager->get('email.admin_address'), NULL, $this->logger);
    ...
    public function handleErrorEmail() {
        ...
        // Create mailer
        $mailer = new Mailer($this->configManager->get('email.admin_address'), $this->configManager->get('email.admin_address'), $this->configManager->get('email.admin_address'), $this->configManager->get('email.admin_subject_tag'), $this->logger);
